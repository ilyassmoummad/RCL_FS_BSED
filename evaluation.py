...
def evaluate(pred_file_path, ref_file_path, team_name, dataset, savepath, metadata=[]):
    ...
    return overall_scores['precision'], overall_scores['recall'], overall_scores['fmeasure (percentage)'], scores_per_set['HB']['precision'], scores_per_set['HB']['recall'], scores_per_set['HB']['f-measure'], scores_per_set['ME']['precision'], scores_per_set['ME']['recall'], scores_per_set['ME']['f-measure'], scores_per_set['PB']['precision'], scores_per_set['PB']['recall'], scores_per_set['PB']['f-measure']
